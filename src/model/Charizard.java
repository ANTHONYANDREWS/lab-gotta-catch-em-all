...
public class Charizard extends Pokemon {
	...
	public String characteristics() {
		return "Charizard is Fire type Pokemon. It is strong and has the ability to soar up to ridiculous heights. With a single breath of fire, it can burn down forests and melt gigantic glaciers.";
	}
